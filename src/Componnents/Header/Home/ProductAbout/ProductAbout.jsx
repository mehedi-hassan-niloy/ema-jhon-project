    ...
    return (
        <div className='mt-12 md:m-36'>
            <div className='grid gap-20 mb-8 md:grid-cols-2'>
                ...
                <div>
                    <div>
                        <h4 className='text-2xl text-extrabold text-orange-500 tracking-widest'>THE PRODUCTS</h4>
                            <h1 className='text-5xl text-extrabold text-black mt-2 mb-6 tracking-widest'>All About Ema-Jhon</h1>
                            <span className="w-20 h-1.5 bg-orange-500 inline-block rounded-2xl"></span>
                    ...
                    <ul className='mt-10'>
                        <div className='grid mb-8 grid-cols-2 md:mr-96'>
                            <li><span className='text-5xl text-orange-500'>.</span> T-Shirt</li>
                            <li><span className='text-5xl text-orange-500'>.</span> Cap</li>
                            <li><span className='text-5xl text-orange-500'>.</span> Shoose</li>
                            <li><span className='text-5xl text-orange-500'>.</span> Bag</li>
                        </div>
                    </ul>
                    <button className='btn bg-orange-600 hover:bg-orange-400 text-white'>Shop Now</button>
                </div>
            </div>
